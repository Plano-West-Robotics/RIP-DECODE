...
//
//@TeleOp(group = "Comp")
//public class StopperTheoreticalTeleop extends BaseTeleOp
//{
//    public enum State
//    {
//        STANDBY,
...
//
//                        if (Math.abs(((DcMotorEx) outtake.motor.motor).getVelocity() - Outtake.MANUAL_ANGULAR_RATE) < Outtake.NORMAL_ERROR_TOLERANCE)
...
//        telemetry.addData("IMU Yaw (Degrees)", Math.toDegrees(drive.getHeading()));
//    }
//}
