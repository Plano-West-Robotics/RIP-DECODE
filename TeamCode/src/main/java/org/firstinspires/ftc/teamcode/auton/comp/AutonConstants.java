...
public class AutonConstants
{
    ...
    public static final Pose RED_LINEUP_2 = new Pose(93.29085681426106, AutonConstants.PICKUP_Y_POS_2, Math.toRadians(0));
    public static final Pose RED_INTAKE_2 = new Pose(AutonConstants.PICKUP_X_POS + 6, AutonConstants.PICKUP_Y_POS_2, Math.toRadians(0));
    public static final Pose RED_INTERMEDIATE_2 = new Pose(112.09271523178808, AutonConstants.PICKUP_Y_POS_2, Math.toRadians(0));
    ...
    public static final double PICKUP_Y_POS_2 = 60.5;
    ...
    public static final Pose FAR_BLUE_LINEUP2 = new Pose(50.7091431857, AutonConstants.PICKUP_Y_POS_2, Math.toRadians(180));
    public static final Pose FAR_BLUE_INTAKE2 = new Pose(8, AutonConstants.PICKUP_Y_POS_2, Math.toRadians(180));
