...
//        Drawing.drawDebug(follower); // TODO: Check if the drawing shows up in Panels, then remove it when no longer necessary because it slows loop times
    ...
    */
    ...
    public void createPaths()
    {
        ...
        headings[pathCount] = new double[] {AutonConstants.BLUE_CLEAR_LINEUP.getHeading()};
        poses[pathCount++] = new Pose[]
            {
                AutonConstants.BLUE_INTAKE_2, AutonConstants.BLUE_CLEAR_LINEUP
            };
        ...
        */
        ...
        paths[7].setVelocityConstraint(AutonConstants.INTAKE_1_VEL_CONSTRAINT);
        paths[10].setVelocityConstraint(AutonConstants.INTAKE_1_VEL_CONSTRAINT);
    }
