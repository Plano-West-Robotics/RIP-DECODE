...
//        }
    ...
    */
    ...
    public void createPaths()
    {
        ...
        headings[pathCount] = new double[] {AutonConstants.FAR_BLUE_SCORE.getHeading(), AutonConstants.FAR_BLUE_BNF_INTERMEDIATE.getHeading()};
        poses[pathCount++] = new Pose[]
            {
        ...
        headings[pathCount] = new double[] {AutonConstants.FAR_BLUE_BNF_LINEUP.getHeading()};
        poses[pathCount++] = new Pose[]
            {
                AutonConstants.FAR_BLUE_BNF_LINEUP, AutonConstants.FAR_BLUE_BNF_INTAKE
            };

        headings[pathCount] = new double[] {AutonConstants.FAR_BLUE_BNF_INTAKE.getHeading(), AutonConstants.FAR_BLUE_SCORE.getHeading()};
        poses[pathCount++] = new Pose[]
            {
                AutonConstants.FAR_BLUE_BNF_INTAKE, AutonConstants.FAR_BLUE_SCORE
            };
