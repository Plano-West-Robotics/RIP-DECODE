...
//    public static final double REGULAR_POWER = 0.85;
    public static final double REGULAR_POWER = 0.7;
...
public static final double TRANSFER_LAUNCH_POWER = 1;
    public static final double TRANSFER_REVERSE_POWER = 0.8;
...
*/
    ...
    {
        tMotor.setPower(TRANSFER_LAUNCH_POWER);
    }
    ...
    {
        tMotor.setPower(-TRANSFER_REVERSE_POWER);
    }
